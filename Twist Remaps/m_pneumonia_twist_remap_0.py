...
def run(protocol_context):
    ...
    plate_13w = protocol_context.load_labware("corning_96_wellplate_360ul_flat", '1')
    plate_15w = protocol_context.load_labware("corning_96_wellplate_360ul_flat", '2')
    plate_16w = protocol_context.load_labware("corning_96_wellplate_360ul_flat", '3')
    plate_14w = protocol_context.load_labware("corning_96_wellplate_360ul_flat", '4')
    plate_11w = protocol_context.load_labware("corning_96_wellplate_360ul_flat", '5')
    plate_18w = protocol_context.load_labware("corning_96_wellplate_360ul_flat", '6')
    plate_17w = protocol_context.load_labware("corning_96_wellplate_360ul_flat", '7')
