...
def run(protocol_context):
    ...
    p300rack = protocol_context.load_labware('opentrons_96_filtertiprack_200ul', '10')
    ...
    p300.flow_rate.blow_out = 400   # blow out faster to avoid droplets clinging to pipette tips
    ...
    for col in range(right, left, -1):
        p300.distribute(45, master_plate.columns()[col][0],
